    ...
    <div className="p-2 cursor-default fixed top-0 mb-[20px] bg-[#050816] w-full">
      <div className="flex p-3 justify-between items-center bg-black-500 text-white">
        <div className="flex items-center">
          ...
          <h1 className="ml-3 text-xl cursor-default font-bold">
          ...
          <a
            href="https://www.instagram.com/heheshekhar/"
            target="_blank"
            rel="noreferrer"
          >
            <svg
          ...
          <a
            href="https://www.snapit.tech/heroft7024/sachin-shekhar-patel"
            target="_blank"
            rel="noreferrer"
          >
            <svg
            ...
            >
              <path
                d="M6 2C5.44772 2 5 2.44772 5 3V21C5 21.5523 5.44772 22 6 22H18C18.5523 22 19 21.5523 19 21V9.41421C19 9.149 18.8946 8.89464 18.7071 8.70711L13.2929 3.29289C13.1054 3.10536 12.851 3 12.5858 3H6Z"
                stroke="currentColor"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          {show && (
            <div className="absolute text-center rounded-xl top-20 right-0 w-1/3 bg-[#050816]">
              <h1
                ...
                className="ml-3 mt-4 cursor-pointer text-[#4d4966] hover:text-white font-bold"
              >
                About
              </h1>
              <h1
                onClick={() =>
                  window.scrollTo({
                    top: (4 * window.innerHeight) / 5, // Scroll to 4/5 of the page height
                    behavior: "smooth",
                  })
                }
                className="ml-3 mt-4 cursor-pointer text-[#4d4966] hover:text-white font-bold"
              ...
              <h1
                ...
                className="ml-3 mt-4 mb-3 cursor-pointer text-[#4d4966] hover:text-white font-bold"
              >
                Contact
              </h1>
            </div>
